...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "beminkin-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/beminkin"
  #   chef.validation_client_name = "beminkin-validator"
  #   chef.validation_key_path = ".chef/beminkin-validator.pem"
  # end
end
